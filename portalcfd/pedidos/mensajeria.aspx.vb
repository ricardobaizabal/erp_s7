...
#Region "Load Initial Values"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblDireccionListLegend.Text = "Listado de Mensajería"
            lblClientEditLegend.Text = "Agregar/Editar Mensajería"
            ...
            btnAddAddress.Text = "Agregar Mensajería"
...
#Region "Load List Of Addresses"
    ...
    Function GetAddresses() As DataSet
        ...
        Dim cmd As New SqlDataAdapter("EXEC pMensajeria  @cmd=1", conn)
...
#Region "Telerik Grid Providers Editing & Deleting Events"
    ...
    Private Sub DeleteAddress(ByVal id As Integer)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("EXEC pMensajeria @cmd='3', @id ='" & id.ToString & "'", conn)
    ...
    Private Sub EditAddress(ByVal id As Integer)
        ...
        Try
            ...
            Dim cmd As New SqlCommand("EXEC pMensajeria @cmd='2', @id='" & id & "'", conn)
    ...
    Protected Sub btnSaveClient_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveClient.Click
        ...
        Try
            ...
            If InsertOrUpdate.Value = 0 Then
                ...
                Dim cmd As New SqlCommand("EXEC pMensajeria @cmd=4, @descripcion='" & txtDescripcion.Text & "', @calle='" & txtStreet.Text & "', @numero_interior='" & txtIntNumber.Text & "', @numero_exterior='" & txtExtNumber.Text & "', @colonia='" & txtColony.Text & "', @pais='" & txtCountry.Text & "', @municipio='" & txtTownship.Text & "', @estadoid='" & cmbStates.SelectedValue & "', @codigo_postal='" & txtZipCode.Text & "'", conn)
            ...
            Else
                ...
                Dim cmd As New SqlCommand("EXEC pMensajeria @cmd=5, @id='" & ClientsID.Value & "',@descripcion='" & txtDescripcion.Text & "', @calle='" & txtStreet.Text & "', @numero_interior='" & txtIntNumber.Text & "', @numero_exterior='" & txtExtNumber.Text & "', @colonia='" & txtColony.Text & "', @pais='" & txtCountry.Text & "', @municipio='" & txtTownship.Text & "', @estadoid='" & cmbStates.SelectedValue & "', @codigo_postal='" & txtZipCode.Text & "'", conn)
