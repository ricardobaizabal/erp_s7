<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" Inherits="erp_s7.portalcfd_Facturar_Extended" MaintainScrollPositionOnPostback="true" CodeBehind="Facturar_Extended.aspx.vb" %>
            ...
            <table width="100%" border="0" align="left">
                <tr>
                    <td align="left" style="width: 10%">
                        <asp:Label ID="lblDescuentoGeneral" runat="server" CssClass="item" Font-Bold="True" Text="Monto:"></asp:Label>
                    </td>
                    <td align="left" style="width: 10%">
                        <telerik:RadNumericTextBox ID="txtDescuento" Type="Currency" MinValue="0" MaxValue="100" Width="90%" runat="server"></telerik:RadNumericTextBox>
                    </td>
                    <td>
